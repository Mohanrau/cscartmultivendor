...
class Repository
{
     ...
     * @return Snippet[]
     */
    public function find(array $conditions, $lang_code = DESCR_SL)
    {
        $result = array();
     ...
     * @return Snippet|false
     */
    public function findByTypeAndCode($type, $code, $lang_code = DESCR_SL)
    {
     ...
     * @return Snippet|false
     */
    public function findActiveByTypeAndCode($type, $code, $lang_code = DESCR_SL)
    {
     ...
     * @return Snippet[]
     */
    public function findByType($type, $lang_code = DESCR_SL)
    {
     ...
     * @return Snippet[]
     */
    public function findByAddon($addon, $lang_code = DESCR_SL)
    {
     ...
     * @return bool
     */
    public function save(Snippet $snippet, $lang_code = DESCR_SL)
    {
